...
func Test_Cassandra_Set_Override(t *testing.T) {
	var (
		key = "john"
		val = []byte("doe")
	)
...
func Test_Cassandra_Get(t *testing.T) {
	var (
		key = "john"
		val = []byte("doe")
	)
...
func Test_Cassandra_Get_NotExist(t *testing.T) {
...
func Test_Cassandra_Close(t *testing.T) {
	utils.AssertEqual(t, nil, testStore.Close())
}

func Test_Cassandra_Conn(t *testing.T) {
